import shippo
from tests.helper import DUMMY_ADDRESS, INVALID_ADDRESS, NOT_POSSIBLE_ADDRESS, ShippoTestCase, shippo_vcr


class AddressTests(ShippoTestCase):
    request_client = shippo.http_client.RequestsClient

    @shippo_vcr.use_cassette(cassette_library_dir="tests/fixtures/address")
