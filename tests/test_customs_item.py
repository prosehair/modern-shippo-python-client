import shippo
from tests.helper import DUMMY_CUSTOMS_ITEM, INVALID_CUSTOMS_ITEM, ShippoTestCase, shippo_vcr


class CustomsItemTest(ShippoTestCase):
    request_client = shippo.http_client.RequestsClient

    @shippo_vcr.use_cassette(cassette_library_dir="tests/fixtures/customs-item")
