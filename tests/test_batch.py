...
import shippo
from tests.helper import ShippoTestCase, DUMMY_BATCH, INVALID_BATCH, create_mock_shipment, shippo_vcr
...
class BatchTests(ShippoTestCase):
    ...
    @shippo_vcr.use_cassette(cassette_library_dir="tests/fixtures/batch")
