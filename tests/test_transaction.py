import shippo
from tests.helper import create_mock_shipment, ShippoTestCase, DUMMY_TRANSACTION, shippo_vcr


class TransactionTests(ShippoTestCase):
    request_client = shippo.http_client.RequestsClient

    @shippo_vcr.use_cassette(cassette_library_dir="tests/fixtures/transaction")
