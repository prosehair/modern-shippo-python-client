...
class APIRequestorTests(TestCase):
    ...
    def test_oauth_token_auth(self):
        ...
        self.assertDictContainsSubset(
            {"Authorization": "Bearer oauth.mocktoken.mocksig"}, headers, "Expect correct token type to used for authorization with oauth token"
        )
    ...
    def test_shippo_token_auth(self):
        ...
        self.assertDictContainsSubset(
            {"Authorization": "ShippoToken shippo_test_mocktoken"}, headers, "Expect correct token type to used for authorization with shippo token"
        )
