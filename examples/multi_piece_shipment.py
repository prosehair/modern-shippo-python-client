...
shipment = shippo.Shipment.create(address_from=address_from, address_to=address_to, parcels=parcel_list, carrier_accounts=carrier, asynchronous=True)
...
transaction = shippo.Transaction.create(rate=rate.object_id, label_file_type="PDF_A4", asynchronous=True)
